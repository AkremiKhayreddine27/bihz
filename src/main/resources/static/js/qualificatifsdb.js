...
var qualitatifsdb = new Vue({
    el: '#qualitatifsdb',
    data: {
        qualitatifs: [],
        qualitatifsform: new __WEBPACK_IMPORTED_MODULE_0__Form__["a" /* Form */]({
            model: {
                nappe: '',
                date: '',
                type: '',
    ...
    methods: {
        saveNewQualitatif: function saveNewQualitatif() {
            var _this = this;

            this.qualitatifsform.post('/qualitatifs').then(function (response) {
                _this.getqualitatifs();
            }).catch(function (error) {});
        },
        deleteQualitatif: function deleteQualitatif(id) {
            var _this2 = this;

            this.qualitatifsform.delete('/qualitatifs/' + id).then(function (response) {
                _this2.getqualitatifs();
            });
        },
        getqualitatifs: function getqualitatifs() {
            var _this3 = this;

            axios.get('/api/qualitatifs').then(function (response) {
